...
<div class="hero">
  <div class="term">
    ...
    <div class="term__body">
      ...
      <p class="term__line term__line--tail"><span class="term__prompt">$</span><span class="term__cursor"></span></p>
...
<section class="sec" id="experience">
  <h2 class="sec__title" data-label="Experience">experience</h2>
...
<!-- ==================== CTF AWARDS ==================== -->
<section class="sec" id="ctf-awards">
  <h2 class="sec__title" data-label="CTF Awards">ctf_awards</h2>

  <div class="awards">
    <div class="award">
      <span class="award__place" data-en="Finalist" data-ko="본선 진출">Finalist</span>
      <span class="award__name" data-en="Hacktheon Sejong (2024) · Beginner" data-ko="핵테온 세종 (2024) · 초급">Hacktheon Sejong (2024) · Beginner</span>
      <span class="award__team">Team: Neophytes</span>
      {% include evidence.html path="/assets/files/hacktheon2024.pdf" en="Certificate →" ko="증빙 →" %}
    </div>
  </div>
</section>
